...
from brain_images_analyzer import BrainImageAnalyzer
from brain_image_processor import BrainImagePreprocessor
...
BRAIN_IMAGE_PATH = os.path.join(BASE_DIR, "assets", "brain_hero.png")
